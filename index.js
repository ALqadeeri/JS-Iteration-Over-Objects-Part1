...
person.email = "abdullahkh56@gmail.com";
...
const hasKey = (object, key) => (object[key] === undefined ? false : true);
...
console.log(hasKey(movies[0], "year"));
console.log(hasKey(movies[1], "city"));
/******************************
...
const hasYear = (objects) =>
  objects.filter((object) => object.year === 1994).length;

console.log(hasYear(movies));
...
const updateGenre = (objects) =>
  objects.filter((object) =>
    object.title === "The Dark Knight"
